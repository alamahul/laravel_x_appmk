...
<div style="" class="card shadow">
  ...
  <div class="card-body">
    ...
    <a href="{{ url('/petugas/tanggapan/detail')}}" class="btn btn-success mb-3">
      <i class="fas fa-smile"></i> Lihat Tanggapan
    </a>
    <a href="{{ url('/petugas/verifikasi_pengaduan')}}" class="btn btn-success mb-3">
      <i class="fas fa-check"></i> Verifikasi Pengaduan
    </a>
    <a href="{{ url('/petugas/tolak_pengaduan')}}" class="btn btn-danger mb-3">
