...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tulis Tanggapan</h1>
    </div>
</div>

  <form class="user" method="post" enctype="multipart/form-data" action="{{url('petugas/tanggapan/tulis')}}">
    @csrf
    ...
    <a href="{{url('petugas/pengaduan/detail/'.$pengaduan->id_pengaduan)}}" class="btn btn-dark">
