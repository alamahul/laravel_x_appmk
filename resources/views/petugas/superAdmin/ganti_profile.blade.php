...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <form class="user" method="post" enctype="multipart/form-data" action="{{url('superAdmin/proses_ganti_profile')}}">
    @csrf
  ...
  <div class="form-group">
    ...
    <a href="{{url('superAdmin/profile')}}" class="btn btn-secondary">
