...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion  no-print" id="accordionSidebar">
  ...
  <li class="nav-item mt-n2">
    <a class="nav-link" href="{{url('/masyarakat/home')}}">
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded bg-gradient-primary">
        ...
        <a class="collapse-item bg-light mb-2" href="{{ url('masyarakat/pengaduan/tulis') }}">Tulis Pengaduan    <i class="fa fa-edit text-primary"></i></a>
        <a class="collapse-item bg-light" href="{{url('masyarakat/pengaduan/lihat')}}">Lihat Pengaduan    <i class="fa fa-eye text-primary"></i></a>
      </div>
    </div>
  </li>
  ...
  <!-- Nav Item - Charts -->
  <li class="nav-item">
    <a class="nav-link" href="{{ url('/masyarakat/logout') }}">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow  no-print">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="dropdown-item" href="{{url('/masyarakat/logout')}}">
