...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion  no-print" id="accordionSidebar">
  ...
  <li class="nav-item pengaturan mt-1">
    <a href="{{url('/petugas/profile')}}" class="nav-link">
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded bg-gradient-primary">
        ...
        <a class="collapse-item bg-light mb-2" href="{{ url('petugas/pengaduan/verifikasi') }}">Verifikasi Pengaduan <i class="fas fa-file-contract text-primary"></i></a>
        <a class="collapse-item bg-light mb-2" href="{{ url('petugas/pengaduan/tanggapi') }}">Tanggapi Pengaduan <i class="fa fa-smile text-primary"></i></a>
      </div>
    </div>
  </li>
  <li class="nav-item mt-n2">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded bg-gradient-primary">
        <h6 class="collapse-header">Opsi</h6>
        <a class="collapse-item bg-light" href="{{url('petugas/tanggapan/kelola')}}"> Kelola Tanggapan    <i class="fa fa-copy text-primary"></i></a>
      </div>
    </div>
  </li>
  <li class="nav-item mt-n2">
    ...
    <div id="collapsefourth" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded bg-gradient-primary">
        <h6 class="collapse-header">Opsi</h6>
        <a class="collapse-item bg-light mb-2" href="{{ url('petugas/masyarakat/lihat') }}"> Lihat Masyarakat    <i class="fas fa-users text-primary"></i></a>
      </div>
    </div>
  </li>
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow  no-print">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="dropdown-item" href="{{url('/petugas/profile')}}">
